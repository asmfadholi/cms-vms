      ...
      <a-layout-sider v-if="!isMobile" v-model="collapsed" theme="light" collapsible :style="{ position: isClient ? 'relative' : 'fixed', top: '0px', left: '0px', minHeight: '100vh'}">
        ...
        <a-menu theme="light" :selected-keys="currentNavigation" mode="inline">
          <a-menu-item key="home">
            <nuxt-link to="/dashboard/admin/area">
              <div>
                <a-icon type="desktop" />
                <span>Beranda</span>
              </div>
          ...
          <a-menu-item key="area">
            <nuxt-link to="/dashboard/admin/area/area">
              <div>
                <a-icon type="dollar" />
          ...
          <a-menu-item key="user">
            <nuxt-link to="/dashboard/admin/area/user">
              <div>
                <a-icon type="dollar" />
          ...
          <a-menu-item key="wahana">
            <nuxt-link to="/dashboard/admin/area/wahana">
              <div>
                <a-icon type="dollar" />
          ...
          <a-menu-item key="ticket">
            <nuxt-link to="/dashboard/admin/area/ticket">
              <div>
                <a-icon type="dollar" />
          ...
          <a-menu-item key="visitor">
            <nuxt-link to="/dashboard/admin/area/visitor">
              <div>
                <a-icon type="dollar" />
          ...
          <a-menu-item key="visitor-wahana">
            <nuxt-link to="/dashboard/admin/area/visitor-wahana">
              <div>
                <a-icon type="dollar" />
...
export default Vue.extend({
  ...
  computed: {
    ...
    currentNavigation () {
      ...
      if (path.includes('admin/area/area')) { return ['area'] }
      if (path.includes('admin/area/user')) { return ['user'] }
      if (path.includes('admin/area/wahana')) { return ['wahana'] }
      if (path.includes('admin/area/ticket')) { return ['ticket'] }
      if (path.includes('admin/area/visitor-wahana')) { return ['visitor-wahana'] }
      if (path.includes('admin/area/visitor')) { return ['visitor'] }
      return ['home']
    }
  },
  watch: {
